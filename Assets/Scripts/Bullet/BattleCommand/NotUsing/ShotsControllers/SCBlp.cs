...
public class SCBlp : ShotsControllerBij
{
    ...
    public override void GetshotsParamFor(ShotParam shotParam, ShotTimer shotTimer, HackingBossPhaseState state)
    {
        ...
        shotParam.Position = new OperationVector2Plus(new OperationVector2Base1[] { shotParam.Position, new OperationVector2Init(Random.insideUnitCircle * m_BlurRadius) });
    }
}
