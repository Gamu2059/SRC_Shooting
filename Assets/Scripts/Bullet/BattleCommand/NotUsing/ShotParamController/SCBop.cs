...
//        // 移行のためコメントアウト
//        //shotParam.Position = new OperationVector2Plus(new OperationVector2Base1[]{ shotParam.Position, new OperationVector2Init(state.GetTransform(shotTimer.GetLaunchTime()).m_Position) });
//    }
//}
