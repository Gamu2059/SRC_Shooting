...
/// <summary>
/// Vector2型の加算を表すクラスの基底クラス。
/// </summary>
public class OperationVector2Plus : OperationVector2Base
{

    /// <summary>
    /// 足す値の配列
    /// </summary>
    private OperationVector2Base[] m_OperationArray;


    /// <summary>
    /// コンストラクタ
    /// </summary>
    public OperationVector2Plus(OperationVector2Base[] operationArray)
    {
    ...
    public override Vector2 GetResult()
    {
        ...
        foreach (OperationVector2Base operation in m_OperationArray)
        {
