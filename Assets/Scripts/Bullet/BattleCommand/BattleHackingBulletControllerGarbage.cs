...
/// <summary>
/// BattleHackingBulletController関係の、今は要らないけど後々役立つかもしれないコードをコメントアウトして保管するためだけのクラス。クラス自体は何もしない。
/// </summary>
public class BattleHackingBulletControllerGarbage : object
{
...
///// </summary>
//public class BattleHackingFreeTrajectoryBulletController : BattleHackingObjectBase
//{
...
//    /// <param name="isCheck">trueの場合、自動的にBulletManagerに弾をチェックする</param>
//    public static BattleHackingFreeTrajectoryBulletController ShotBullet(CommandBulletShotParam shotParam, SimpleTrajectory trajectoryBase, float dTime, bool isCheck = true)
//    {
//        var bullet = CreateBullet(shotParam);
