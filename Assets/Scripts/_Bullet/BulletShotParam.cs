...
public struct BulletShotParam
{
	...
	/// 弾を発射させるキャラ。
	/// </summary>
	public CharaControllerBase BulletOwner;
	...
	public BulletShotParam( CharaControllerBase shotOwner ) : this( shotOwner, 0 )
	{
	}
	...
	public BulletShotParam( CharaControllerBase shotOwner, int bulletIndex ) : this( shotOwner, bulletIndex, 0, -1 )
	{
	}
	...
	public BulletShotParam( CharaControllerBase shotOwner, int bulletIndex, int bulletParamIndex, int orbitalIndex ) : this( shotOwner, bulletIndex, bulletParamIndex, orbitalIndex, null, null, null )
	{
	}
	...
	public BulletShotParam( CharaControllerBase shotOwner, int bulletIndex, int bulletParamIndex, int orbitalIndex, Vector3? position, Vector3? rotation, Vector3? scale )
	{
