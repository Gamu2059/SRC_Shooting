...
/// 座標と座標を結んで動く敵の挙動。
/// </summary>
[Serializable, CreateAssetMenu(menuName = "Param/BattleReal/EnemySequence/Unit/LerpAnimation", fileName = "lerp_animation.behavior_unit.asset", order = 30)]
public class BattleRealEnemyLerpAnimationBehavior : BattleRealEnemyBehaviorUnit
{
