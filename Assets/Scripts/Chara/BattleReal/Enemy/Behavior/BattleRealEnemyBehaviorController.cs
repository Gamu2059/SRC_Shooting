...
public class BattleRealEnemyBehaviorController : ControllableObject
{
    ...
    private Stack<BattleRealEnemyBehaviorGroupBase> m_GroupStack;
    private BattleRealEnemyBehaviorGroupBase m_CurrentGroup;
    private BattleRealEnemyBehaviorUnitBase m_CurrentUnit;
    ...
    {
        base.OnInitialize();
        m_GroupStack = new Stack<BattleRealEnemyBehaviorGroupBase>();
        m_CurrentGroup = null;
        m_CurrentUnit = null;
    }
    ...
    /// 処理階層をルートから始める
    /// </summary>
    public void BuildBehavior(BattleRealEnemyBehaviorGroupBase behaviorGroup)
    {
    ...
    private void GoNextUnit(bool isForward, bool isSelfLoop, bool isGroupEnded)
    {
        ...
        if (nextReferenceElement is BattleRealEnemyBehaviorGroupBase nextReferenceGroup)
        {
        ...
        if (nextReferenceElement is BattleRealEnemyBehaviorUnitBase nextReferenceUnit)
        {
