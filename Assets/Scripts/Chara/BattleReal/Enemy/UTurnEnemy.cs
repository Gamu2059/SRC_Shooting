...
public class UTurnEnemy : BattleRealEnemyController
{
    ...
    public override void OnStart()
    {
        ...
        m_ShotTimeCount = m_StraightMoveShotParam.Interval;
    }
    ...
    public override void OnLateUpdate()
    {
        ...
        if (!isOutOfField)
        {
            ...
            {
                OnShot(m_StraightMoveShotParam, true);
            });
        ...
        switch (m_Phase)
        {
            case E_PHASE.BEGIN_STRAIGHT:
                ...
                if (Vector2.Dot(beforeDir.ToVector2XZ(), beginDeltaMove.ToVector2XZ()) <= 0)
                {
                    ...
                    m_ShotTimeCount = m_CircleMoveShotParam.Interval;
                }
    ...
    protected virtual void Shot()
    {
        ...
        else if (m_Phase == E_PHASE.CIRCLE_MOVE)
        {
            ...
            {
                m_ShotTimeCount = 0;
                OnShot(m_CircleMoveShotParam, true);
            }
        }
    }

    protected virtual void OnShot(EnemyShotParam param, bool isPlayerLook = false)
    {
        int num = param.Num;
