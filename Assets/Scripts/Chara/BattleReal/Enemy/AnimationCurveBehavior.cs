...
/// </summary>
[Serializable, CreateAssetMenu(menuName = "Param/BattleReal/Enemy/Behavior/AnimationCurve", fileName = "param.battle_real_enemy_behavior.asset")]
public class AnimationCurveBehavior : BattleRealEnemyBehaviorUnit
{
    ...
    public override void OnStart()
    {
        ...
        m_StartPosition = m_Enemy.transform.localPosition;
        m_StartAngle = m_Enemy.transform.localEulerAngles.y;
