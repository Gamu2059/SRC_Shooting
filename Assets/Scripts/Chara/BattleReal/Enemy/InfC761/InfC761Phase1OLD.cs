...
public class InfC761Phase1OLD : BattleRealBossBehavior
{
    public enum E_PHASE
    {
        START,
    ...
    private InfC761Phase1ParamSetOld m_ParamSet;
    ...
    public InfC761Phase1OLD(BattleRealEnemyBase enemy, BattleRealBossBehaviorUnitParamSet paramSet) : base(enemy, paramSet)
    {
