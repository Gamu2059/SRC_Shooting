...
/// プレイヤーに向かって飛んでくる敵の挙動。
/// </summary>
[Serializable, CreateAssetMenu(menuName = "Param/BattleReal/EnemySequence/Unit/PlayerDirection", fileName = "player_direction.enemy_behavior_unit.asset", order = 10)]
public class BattleRealEnemyPlayerDirectionBehavior : BattleRealEnemyBehaviorUnit
{
