...
/// </summary>
public class InfC761Hacker1 : BattleHackingEnemyController
{
    public enum E_PHASE
    {
        START,
    ...
    private InfC761Hacker1ParamSet m_ParamSet;

    private StateMachine<E_PHASE> m_StateMachine;
    private BattleHackingBossBehaviorParamSet[] m_BehaviorParamSets;

    private List<BattleHackingBossBehavior> m_Behaviors;
    private BattleHackingBossBehavior m_CurrentBehavior;
