...
[Serializable, CreateAssetMenu(menuName = "Param/BattleReal/Enemy/EnemyBehavior/RapidShotAnimationCurve", fileName = "behavior.rapid_shot_animation_curve.asset")]
public class RapidShotAnimationCurveEnemyParamSet : BattleRealEnemyBehaviorParamSet
{
    [Header("Move Param")]
    ...
    public float RapidShotInterval => m_RapidShotInterval;
